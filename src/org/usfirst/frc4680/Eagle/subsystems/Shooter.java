...
public class Shooter extends Subsystem {
    ...
    private final SpeedController feederOne = new Spark(7);
    private final SpeedController feederTwo = new Spark(8);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DEFAULT_COMMAND
        ...
        setDefaultCommand(new StopShooterWheel());
    }
    ...
    public void spinFeedersMotor(double speed) {
    	feederOne.set(speed);
    	feederTwo.set(speed);
    }
}
