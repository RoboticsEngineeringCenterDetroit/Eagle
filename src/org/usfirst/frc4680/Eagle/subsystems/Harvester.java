...
public class Harvester extends Subsystem {
    ...
    private final SpeedController harvesterMotor = RobotMap.harvesterHarvesterMotor;
    private final Relay harvesterSolenoid = RobotMap.harvesterHarvesterSolenoid;
